...
//		mongoTemplate.dropCollection("users");
		...
		Movie movie1 = new Movie(BigInteger.valueOf(111L),"Leo","inox",126,"Book ASAP");
	 	Movie movie2 = new Movie(BigInteger.valueOf(222L),"Vikram","inox",122,"Book ASAP");
	 	Movie movie3 = new Movie(BigInteger.valueOf(333L),"Singam","inox",200,"Book ASAP");
		Movie movie4 = new Movie(BigInteger.valueOf(444L),"Jailer","inox",150,"Book ASAP");
